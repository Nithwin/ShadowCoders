...
exports.generateJsonFromAi = exports.listAvailableModels = void 0;
const generative_ai_1 = require("@google/generative-ai");
const env_1 = require("../config/env"); // Assuming your env.ts has GOOGLE_API_KEY
...
const generateJsonFromAi = async (prompt) => {
    ...
    const apiKeyPrefix = env_1.env.GOOGLE_API_KEY.substring(0, 10);
    console.log(`Using API key: ${apiKeyPrefix}... (length: ${env_1.env.GOOGLE_API_KEY.length})`);
    let lastError = null;
    const errorsByModel = [];
...
exports.generateJsonFromAi = generateJsonFromAi;
