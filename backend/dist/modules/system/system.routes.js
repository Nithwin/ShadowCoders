...
const registerSystemRoutes = (app) => {
    // Get system resource metrics (CPU, Memory, Disk, Network)
    app.get('/api/admin/system/resources', auth_1.verifyAccess, (0, auth_1.requireRole)('STAFF'), systemController.getSystemResourcesHandler);
};
