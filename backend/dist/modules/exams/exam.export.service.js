...
exports.exportExamResultsToExcel = void 0;
const ExcelJS = __importStar(require("exceljs"));
const prisma_1 = require("../../lib/prisma");
const exportExamResultsToExcel = async (examId, options = {}) => {
    const { fields = [
        'studentName',
        'email',
        'regNo',
        ...
        'percentage',
        'questionScores',
    ], includeSummary = true, includeExamInfo = true, } = options;
    ...
    if (attempts.length > 0) {
        ...
        const emptyRowData = {};
        if (fields.includes('studentName'))
            emptyRowData.studentName = 'No submissions yet';
        if (fields.includes('email'))
            emptyRowData.email = '-';
        if (fields.includes('regNo'))
            emptyRowData.regNo = '-';
        if (fields.includes('startedAt'))
            emptyRowData.startedAt = '-';
        if (fields.includes('submittedAt'))
            emptyRowData.submittedAt = '-';
        if (fields.includes('score'))
            emptyRowData.score = '-';
        if (fields.includes('maxScore'))
            emptyRowData.maxScore = '-';
        if (fields.includes('percentage'))
            emptyRowData.percentage = '-';
...
exports.exportExamResultsToExcel = exportExamResultsToExcel;
//# sourceMappingURL=exam.export.service.js.map