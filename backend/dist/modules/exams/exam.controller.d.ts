...
export declare const listExamsHandler: RequestHandler;
export declare const getExamByIdHandler: RequestHandler;
export declare const createExamHandler: RequestHandler;
export declare const updateExamHandler: RequestHandler;
export declare const deleteExamHandler: RequestHandler;
