...
-- This table tracks migration history and should also have RLS enabled for security
...
-- Note: The above policies grant full access to the 'postgres' role (service_role).
-- If your service_role uses a different role name, you may need to adjust the policies.
-- 
-- Alternative approach: Grant BYPASSRLS privilege to the service_role user
-- This is more efficient but less granular:
-- ALTER ROLE postgres BYPASSRLS;
--
-- However, using policies is more explicit and allows for future fine-grained control
-- if you need to add restrictions for other roles (anon, authenticated, etc.)
