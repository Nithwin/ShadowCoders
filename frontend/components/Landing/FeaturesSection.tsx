    ...
    <section id="features" ref={sectionRef} className="py-16 sm:py-20">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="feat-heading invisible text-center mb-14">
          <span className="inline-flex items-center text-xs font-semibold text-blue-700 bg-blue-50 border border-blue-100 rounded-full px-3 py-1 mb-4">
            Features
          </span>
        ...
        <div className="feat-grid grid sm:grid-cols-2 lg:grid-cols-3 gap-5" style={{ perspective: 800 }}>
          {features.map((f) => (
            <div
              key={f.title}
              className="feat-card invisible group relative rounded-2xl border border-gray-200 bg-white p-6 hover:border-gray-300 hover:shadow-lg hover:shadow-gray-100/80 transition-all duration-300"
            >
              {/* accent bar at top */}
              <div
