...
export default function QuestionNavigationButtons({
  ...
  return (
    <div className="sticky bottom-0 left-0 right-0 bg-white border-t border-gray-300 shadow-2xl z-50 px-6 py-5">
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <div className="text-sm text-gray-600 font-semibold bg-gray-50 px-4 py-2 rounded-lg border border-gray-200">
        ...
        <button
          ...
          type="button"
          className="bg-blue-600 hover:bg-blue-700 text-white border-0 px-8 py-3 rounded-lg font-semibold shadow-md hover:shadow-lg transition-all min-w-[140px] flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Next Question
